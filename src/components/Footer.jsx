    ...
    return (
        <TextosFooter>
            <Block>
                <Title>
                    <h1>Contato</h1><hr></hr>
                </Title>                                     {/* Organizei o código em divisões, TextosFooter: que tem os textos e as linhas em baixo dos textos  */}
...
text-align: center;                                {/* Estilos relacionados a MsgDireitos, para melhor leitura/execução do código */}
font-size:15px;
color:white;
line-height: 25px;
font-family: "Montserrat", sans-serif; {/* Fonte momentânea que utilizei, pois a Rubik não estava dando certo */}
font-weight: 300;
